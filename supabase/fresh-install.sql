-- ⚠️ FRESH INSTALL: DELETES EVERYTHING in the public schema of this project,
-- then creates the Lumen database from scratch. Only for an empty/new project.
-- For an existing Lumen database apply supabase/migrations instead.
