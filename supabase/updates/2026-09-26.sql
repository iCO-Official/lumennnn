-- Lumen update 2026-09-26: routine fixes + push reminders.
...
-- ===== Every minute: ask the site to send due reminders =====
CREATE EXTENSION IF NOT EXISTS pg_cron WITH SCHEMA pg_catalog;
GRANT USAGE ON SCHEMA cron TO postgres;
CREATE EXTENSION IF NOT EXISTS pg_net WITH SCHEMA extensions;

-- ⬇️ Your site's address (change it if your Vercel domain is different)
UPDATE public.push_config SET site_url = 'https://lumen-monastyrcuki-6554s-projects.vercel.app' WHERE id = 1;
...
SELECT cron.schedule(
  ...
  SELECT net.http_post(
    url := (SELECT site_url FROM public.push_config WHERE id = 1) || '/api/push-tick',
